...
input_file_path = '/Users/mac/Desktop/WBG experiment/Python/PL Data analyze/241211/Remove noise csv/Nr 2.csv'
...
for i, (cycle_time, intensity) in enumerate(cycle_data.items()):
    ...
    # Define dynamic fitting range for Peak 2 based on the cycle number
    if i < 2:
        peak2_range = (wavelength >= 580) & (wavelength <= 900)
    elif 2 <= i <= 4:
        peak2_range = (wavelength >= 580) & (wavelength <= 900)
    elif 5 <= i <= 31:
        peak2_range = (wavelength >= 660) & (wavelength <= 900)
    else:  # i >= 50 and i <= 90
        peak2_range = (wavelength >= 710) & (wavelength <= 900)
...
photo_dir = "/Users/mac/Desktop/WBG experiment/Python/PL Data analyze/241211/PVK Photos"
...
recipe_path = "/Users/mac/Desktop/WBG experiment/Python/PL Data analyze/241211/Formatted Recipes.csv"
