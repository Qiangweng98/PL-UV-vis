...
input_dir = '/Users/mac/Desktop/WBG experiment/Python/PL Data analyze/250526'  # Define the directory path here
...
for input_file_path in csv_files:
    ...
    corrected_data.to_csv(output_file_path, index=False, header=False,
                          mode='a')  # Append the corrected data to the file
